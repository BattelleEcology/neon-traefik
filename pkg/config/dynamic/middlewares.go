...
// More info: https://doc.traefik.io/traefik/v3.6/middlewares/http/basicauth/
...
// More info: https://doc.traefik.io/traefik/v3.6/middlewares/http/circuitbreaker/
...
// This middleware restricts access to your services to known users.
// More info: https://doc.traefik.io/traefik/v3.6/middlewares/http/digestauth/
...
// More info: https://doc.traefik.io/traefik/v3.6/middlewares/http/forwardauth/
type ForwardAuth struct {
	...
	// More info: https://doc.traefik.io/traefik/v3.6/middlewares/http/forwardauth/#authresponseheadersregex
	...
	// HeaderField defines a header field to store the authenticated user.
	// More info: https://doc.traefik.io/traefik/v3.6/middlewares/http/forwardauth/#headerfield
	HeaderField string `json:"headerField,omitempty" toml:"headerField,omitempty" yaml:"headerField,omitempty" export:"true"`
...
// More info: https://doc.traefik.io/traefik/v3.6/middlewares/http/retry/
type Retry struct {
