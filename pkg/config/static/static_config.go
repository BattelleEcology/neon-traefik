...
type Configuration struct {
	...
	Ready   *ready.Handler  `description:"Enable readiness." json:"ready,omitempty" toml:"ready,omitempty" yaml:"ready,omitempty" label:"allowEmpty" file:"allowEmpty" export:"true"`
