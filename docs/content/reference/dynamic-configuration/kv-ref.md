...
| `traefik/http/middlewares/Middleware06/compress/defaultEncodingPriority/0` | `foobar` |
| `traefik/http/middlewares/Middleware06/compress/defaultEncodingPriority/1` | `foobar` |
