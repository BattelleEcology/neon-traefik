...
| `traefik/http/middlewares/Middleware06/compress/acceptedContentTypes/0` | `foobar` |
| `traefik/http/middlewares/Middleware06/compress/acceptedContentTypes/1` | `foobar` |
...
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/applyTokenRateLimit` | `true` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/authService/serviceUrl` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/authService/tokenHeader` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/authService/tokenVerifyEndpoint` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/burst` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/period` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/rate` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/database` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/host` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/keyPrefix` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/password` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/port` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/storage/encrypt` | `true` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/storage/keyset` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/tls/ca` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/tls/cert` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/tls/key` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/tls/useMTls` | `true` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/tls/verify` | `true` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/useTls` | `true` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/redis/username` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/requestMethodsPassthrough/0` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/requestMethodsPassthrough/1` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/scopes/claimName` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/scopes/prefixFilter/0` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/scopes/prefixFilter/1` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/scopes/rateScopeLimitedName` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/scopes/rateScopeUnlimitedName` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/scopes/serviceScopeName` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/sourceCriterion/ipStrategy/depth` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/sourceCriterion/ipStrategy/excludedIPs/0` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/sourceCriterion/ipStrategy/excludedIPs/1` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/sourceCriterion/requestHeaderName` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/sourceCriterion/requestHost` | `true` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/sourceRange/0` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/sourceRange/1` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/tokenBurst` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/tokenHeader` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/tokenPeriod` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/tokenQueryParam` | `foobar` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/tokenRate` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/tokenWeight` | `42` |
| `traefik/http/middlewares/Middleware15/neonAPIRateLimit/weight` | `42` |
